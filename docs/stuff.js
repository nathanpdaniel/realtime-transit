    ...
    fetch("http://developer.itsmarta.com/RealtimeTrain/RestServiceNextTrain/GetRealtimeArrivals?apikey=49741de7-d606-46f9-aecc-d36a1d1963e9").then(function (response) {
        ...
        if (contentType && contentType.indexOf("application/json") !== -1) {
            ...
            return response.json().then(function (trainData) {
                ...
                var requestedStation = "VINE CITY STATION"
                var requestedDirection = "W";
                var count = 0;
                ...
                trainDataArr.forEach(train => {
                    ...
                    if (count == 1) {
                        console.log(count + ' ' + currentStation + ' ' + train.DIRECTION);
                    }
                    ...
                    //if (currentStation == requestedStation && train.DIRECTION == requestedDirection) {
                        ...
                        if (currentStation == requestedStation && train.DIRECTION == requestedDirection) {
                            console.log(lastTime + '. In ' + train.WAITING_SECONDS + ' seconds, arriving at ' + nextTime);
                            console.log(c1);
                            console.log(c2);
                        }
                    //}
